        ...
        >
          ...
          <div className="space-y-6">
            ...
            <p className="text-slate-400 leading-relaxed">
              Я Frontend-разработчик из Душанбе, увлеченный созданием удобных и эстетичных веб-приложений. 
              Имею опыт работы более года, в данный момент занимаю позицию младшего специалиста в государственной структуре Таджикистана.
            </p>
            
            <p className="text-slate-400 leading-relaxed">
              Мой путь в IT начался в Северо-Кавказском федеральном университете (2015-2019). Я верю в непрерывное обучение: 
              <strong className="text-slate-200"> успешно окончил курс «Frontend-разработчик PRO» в Skillbox</strong>, а также прошел обучение в Алиф Академии (JavaScript) и Нетологии (Python).
            </p>
            ...
            <div className="grid grid-cols-2 gap-4 pt-4">
              ...
              <div>
                ...
                <p className="text-slate-500">Русский (Родной), Английский (B1)</p>
              </div>
              <div>
...
import React from "react";
import { motion } from "framer-motion";
import Person from "../km.jpg";

export const About: React.FC = () => {
	return (
		<section
			id="about"
			className="w-full py-20 md:py-32 bg-dark relative"
		>
			<div className="max-w-7xl mx-auto px-6">
				<motion.div
					initial={{ opacity: 0, y: 50 }}
					...
					viewport={{ once: true, margin: "-100px" }}
					transition={{ duration: 0.6 }}
					// *** ИЗМЕНЕНИЕ ЗДЕСЬ: items-start вместо items-center ***
					...
					<div className="relative group">
						...
						<div className="relative rounded-xl overflow-hidden border border-white/10">
							<img
								src={Person}
								alt="Komil Muminov"
								className="w-full h-[800px] object-cover grayscale group-hover:grayscale-0 transition-all duration-500"
							/>
						</div>
					</div>
