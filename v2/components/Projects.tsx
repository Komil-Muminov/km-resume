    ...
    <section id="projects" className="w-full py-20 md:py-32">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12">
          ...
          <a href="https://github.com/Komil-Muminov" target="_blank" rel="noreferrer" className="mt-4 md:mt-0 text-primary hover:text-white transition-colors flex items-center gap-2">
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {project.tech.map(t => (
                    <span key={t} className="text-xs font-medium text-slate-300 bg-white/5 px-2 py-1 rounded">
                      {t}
                    </span>
                  ))}
                </div>
