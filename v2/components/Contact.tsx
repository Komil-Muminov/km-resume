...
export const Contact: React.FC = () => {
  return (
    <section id="contact" className="w-full py-20 md:py-32 bg-gradient-to-b from-dark to-slate-900 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6">Давайте работать вместе</h2>
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4 p-4 rounded-xl bg-white/5 border border-white/5 hover:bg-white/10 transition-colors">
                ...
                <div>
                  ...
                  <p className="text-white font-medium">+992 90 001 9116</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 p-4 rounded-xl bg-white/5 border border-white/5 hover:bg-white/10 transition-colors">
                ...
                <div>
                  ...
                  <a href="mailto:itmuminoff@gmail.com" className="text-white font-medium hover:text-primary transition-colors">
          ...
          >
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
              ...
              <button 
                className="w-full bg-gradient-to-r from-primary to-blue-600 text-white font-bold py-4 rounded-lg hover:shadow-lg hover:shadow-primary/25 transition-all flex items-center justify-center gap-2"
              >
