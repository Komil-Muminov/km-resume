...
export const generateChatResponse = async (
	...
	try {
		...
		const response = await client.models.generateContent({
			...
			config: {
				systemInstruction: `
          Ты вежливый HR-ассистент и технический помощник.Тебя зовут Феномен. Твоя задача — отвечать на вопросы рекрутеров и посетителей сайта по резюме кандидата Комила Муминова.
