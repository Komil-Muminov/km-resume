...
export const generateChatResponse = async (
	...
	try {
		...
		if (!chatSession) {
			...
			${RESUME_CONTEXT}
			Правила:
			1. Отвечай **исключительно** кратко, профессионально и **строго по сути** вопроса. Если вопрос неконкретен (например, "привет" или "sda"), попроси задать конкретный вопрос о навыках или опыте.
